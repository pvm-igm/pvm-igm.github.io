...
color_label2 = c("#F37F9061", "#C9F2FF", "#F37F9061", "#C9F2FF", "#F37F90C8", "#B2E9FB", "#6BCFEF", "#EC4B63")
...
sc2_variants <- list(
  ...
  "VOC: Omicron (FE.1)" = "FE.1",
  "VOC: Omicron (KRAKEN)" = "KRAKEN",
  "VOC: Omicron (FE.1.2)" = "FE.1.2",
...
gi_bahia_epiwseq_plot <- plotly::ggplotly(
  ggplot() +
    ...
    scale_fill_manual(values = c(
      ...
      "VOC: Omicron (KRAKEN)" = "#0000FF",
      "VOC: Omicron (FE.1)" = "#FFFF00",
      "VOC: Omicron (FE.1.2)" = "#FF3399",
