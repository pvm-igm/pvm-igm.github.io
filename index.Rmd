...
color_label = c("#EA2F4B", "#24AFDD", "#EA2F4B", "#24AFDD", "#EA2F4B", "#24AFDD", "#EA2F4B", "#24AFDD", "#EA2F4B", "#24AFDD")
names(color_label) <- redcap_sars2diag_result_epiypcr$label

color_label2 = c("#F37F9061", "#C9F2FF", "#F37F9061", "#C9F2FF", "#F37F90C8", "#B2E9FB", "#F37F9061", "#C9F2FF", "#EC4B63","#6BCFEF")
...
sc2_variants <- list(
  ...
  "VOC: Omicron (DL.1)" = c("DL.1", unique(gi$pangolin_lineage[grep("^DL\\.1\\.", gi$pangolin_lineage)])),
    "VOC: Omicron (JN.1)" = c("JN.1",
unique(gi$pangolin_lineage[grep("^JN\\.1\\.", gi$pangolin_lineage)])),
  "VOC: Omicron (MJ.1)" = "MJ.1", unique(gi$pangolin_lineage[grep("^MJ\\.1\\.", gi$pangolin_lineage)]))
