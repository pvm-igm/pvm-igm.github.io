...
pacman::p_load("devtools", "dplyr", "flexdashboard", "fontawesome", "GISAIDR", "ggplot2",
          "htmltools", "httr", "knitr", "pandoc", "plotly", "plyr", "rstudioapi", "reshape2")
...
redcap_sars2diag_gal1 <- redcap_sars2diag_gal[c("rec", "requisitante", "dt_coleta", "mun_req", "idade",
                                                "sexo", "dt_recebimento", "dt_liberacao", "data_teste",
                                                "placa_id", "termociclador", "kit_pcr", "lote_pcr",
                                                "result_pcr", "ct_b2m", "ct_orflab", "ct_covn",
                                                "ct_gene4")]
redcap_sars2diag_gal1 <- redcap_sars2diag_gal1[redcap_sars2diag_gal1$data_teste != "", ]

redcap_sars2diag_gal2 <- redcap_sars2diag_gal[c("rec", "requisitante", "dt_coleta", "mun_req", "idade",
...
names(redcap_sars2diag_gal2) <- c("rec", "requisitante", "dt_coleta", "mun_req", "idade", "sexo",
                                  "dt_recebimento", "dt_liberacao", "data_teste", "placa_id",
                                  "termociclador", "kit_pcr", "lote_pcr", "result_pcr", "ct_b2m",
                                  "ct_orflab", "ct_covn")
redcap_sars2diag_gal2 <- redcap_sars2diag_gal2[redcap_sars2diag_gal2$data_teste != "", ]

redcap_sars2diag <- Reduce(function(x, y) merge(x, y, all = TRUE), list(redcap_sars2diag_igm, redcap_sars2diag_gal1, redcap_sars2diag_gal2))
