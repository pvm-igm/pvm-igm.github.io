...
packages <- c("fontawesome", "devtools", "dplyr", "flexdashboard", "fontawesome", "GISAIDR", "ggplot2",
          "htmltools", "knitr", "pandoc", "plotly", "plyr", "REDCapR", "reshape2", "rstudioapi")
...
# token_2 <- args[3]
# report_id_2 <- as.integer(args[4])
# redcap_sars2diag_gal <- REDCapR::redcap_report(
#   redcap_uri = "https://bdp.bahia.fiocruz.br/api/",
#   token = token_2,
#   report_id = report_id_2)$data
redcap_sars2diag_gal_raw_path <- "~/pvm-igm.github.io"
...
token_3 <- args[3]
report_id_3 <- as.integer(args[4])
redcap_sars2seq <- REDCapR::redcap_report(
  redcap_uri = "https://bdp.bahia.fiocruz.br/api/",
  token = token_3,
  report_id = report_id_3)$data
