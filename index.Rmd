...
```{r}
redcap_sars2diag_result_epiypcr <- ddply(redcap_sars2diag_result, .(redcap_sars2diag_result$epiypcr,
                                                                    redcap_sars2diag_result$result_pcr), nrow, .drop = TRUE)
...
color_label2 = c("#F37F9061", "#C9F2FF", "#F37F9061", "#C9F2FF", "#F37F90C8", "#B2E9FB", "#6BCFEF")
